...
let oldcards = document.getElementsByClassName('deck');
  ...
  if (evt.target.className === "card"){
    ...
    order.push(y);
      if (opencards === 0){
        ...
        opencards = 0;
        let del = document.getElementById(order.pop(y));
...
function newCards(){
  ...
  for (var card of cards){
      ...
      let newCountry = document.createElement('figcaption');
      ...
      let newCCard = document.createElement('li');
  ...
  let parentDiv = oldcards[0].parentNode;
...
function openCongrads(){
  let fonbox =  document.createElement('div');
  fonbox.id = 'layer3';
...
function closeCongrads(){
  let fonbox =  document.getElementById('layer3');
  let popbox =  document.getElementById('layer4');
  fonbox.remove();
  popbox.remove();
  restartGame();
}
